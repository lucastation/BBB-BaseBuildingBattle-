...
public class PlayerInputAlpha : MonoBehaviour
{
    [SerializeField]
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, 100, mask)) 
        {
           ...
           // Debug.Log(PosX + " " + PosY + " " + PosZ);
            ...
            {
               homeGrid.SetValue(ObjToMove.position, ObjToPlace[slotNumber]);
               Instantiate(ObjToPlace[slotNumber], homeGrid.GetWorldPosition(ObjToMove.position), Quaternion.identity);
            }
